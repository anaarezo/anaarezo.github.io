...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center text-center space-y-8 min-h-screen bg-white dark:bg-black py-16">
      ...
      />
      <div>
        <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">{t('title')}</h1>
        <p className="text-xl text-zinc-700 dark:text-zinc-300 mt-2">{t('role')}</p>
        <p className="text-md text-zinc-600 dark:text-zinc-400">📍 {t('location')}</p>
      </div>
